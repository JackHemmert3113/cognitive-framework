...
echo "2. @cognitive/test-framework - AI-powered test generation"
echo ""
...
echo "  npm install @cognitive/test-framework"
echo ""
echo "Option 3: Everything"
echo "  npm install @cognitive/agent-core @cognitive/test-framework"
echo ""
echo "💡 Quick Example:"
echo "---------------"
