...
echo "2. @cognitive/ai-test-framework - AI-powered test generation"
echo ""
...
echo "  npm install @cognitive/ai-test-framework"
echo ""
echo "Option 3: Everything"
echo "  npm install @cognitive/agent-core @cognitive/ai-test-framework"
echo ""
echo "💡 Quick Example:"
echo "---------------"
